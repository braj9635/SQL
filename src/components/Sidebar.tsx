...
import { Database, Table, Columns, ChevronRight, ChevronDown, History, CheckCircle, AlertCircle, Clock, Lightbulb, ArrowRight } from 'lucide-react';
import { SCHEMA, QueryResult } from '../lib/mockDb';
...
export function Sidebar({ onSelectTable, history, onSelectHistory, onSelectChallenge, className }: SidebarProps) {
                    ...
                    <div className="flex items-center justify-between">
                       ...
                       {item.result?.executionTime !== undefined && (
                         <div className="flex items-center gap-0.5 text-[10px] text-slate-400">
                           ...
                           {item.result.executionTime.toFixed(1)}ms
                         </div>
                       )}
                    </div>
